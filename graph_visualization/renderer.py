...
def _draw_panel(surface, font, small_font, graph, mode, edit_submode,
                start_node, end_node, selected_algo, status_msg, width, height):
    ...
    if status_msg:
        ...
        line(status_msg[:28], color, small_font)
        if len(status_msg) > 28:
            line(status_msg[28:], color, small_font)
...
def launch(width: int = 1100, height: int = 720, directed: bool = False):
    ...
    while True:
                            ...
                            if edge_source is None:
                                ...
                                if hit != edge_source:
                                    ...
                                    start_input(
                                        ...
                                        lambda w, u=src, v=hit: add_edge_between(u, v, w)
                                    )
                                else:
                                    edge_source = None
                                    set_status("Edge mode - click source node")
        ...
        # draw edge-in-progress line in edge mode
        ...
        # draw panel
        _draw_panel(screen, font, small_font, graph, mode, edit_submode,
                    start_node, end_node, selected_algo, status_msg, width, height)
